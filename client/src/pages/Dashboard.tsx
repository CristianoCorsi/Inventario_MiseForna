    ...
    <div className="py-6 mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
      ...
      <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          value={statsLoading ? t("app.loading") : String(stats?.totalInventory || 0)}
          icon={
        ...
        <StatCard
          ...
          value={statsLoading ? t("app.loading") : String(stats?.itemsOnLoan || 0)}
          icon={
            <svg className="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <StatCard
          ...
          value={statsLoading ? t("app.loading") : String(stats?.overdueItems || 0)}
