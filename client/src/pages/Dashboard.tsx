    ...
    <div className="py-6 mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
      ...
      <div className="pb-5 border-b border-gray-200 sm:flex sm:items-center sm:justify-between">
        ...
        <div className="mt-3 flex sm:mt-0 sm:ml-4">
          ...
          <button 
            type="button" 
            className="ml-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-secondary hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary"
      ...
      <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard 
          ...
          value={statsLoading ? "Loading..." : String(stats?.totalInventory || 0)}
          icon={
        ...
        <StatCard 
          title="Items on Loan"
          value={statsLoading ? "Loading..." : String(stats?.itemsOnLoan || 0)}
          icon={
            <svg className="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <StatCard 
          title="Overdue Items"
          value={statsLoading ? "Loading..." : String(stats?.overdueItems || 0)}
        ...
        <StatCard 
          ...
          value={statsLoading ? "Loading..." : String(stats?.newItems || 0)}
          icon={
            <svg className="w-6 h-6 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <QuickAction 
          ...
          description="Create and print QR code labels for your inventory items"
          icon={
