...
const it = {
  ...
  "qrcode.batchGenerate": "Genera QR in blocco",
  "qrcode.print": "Stampa",
  ...
  "qrcode.emptyCodesList": "Lista di codici QR non assegnati",
  "qrcode.emptyCodesDescription":
    "QR codes che possono essere associati agli articoli",
  ...
  "qrcode.scannerSoon":
    "La funzionalità di scansione sarà implementata a breve.",
  "qrcode.code": "Codice",
  ...
  "qrcode.noEmptyCodesDescription":
    "Genera nuovi codici QR per associarli agli articoli successivamente",
  "qrcode.prefix": "Prefisso",
  "qrcode.prefixHelp":
    "Un prefisso significativo aiuta a identificare i codici (es. ITEM-, TOOL-)",
  "qrcode.quantityHelp": "Numero di codici QR da generare (max 100)",
  "qrcode.descriptionPlaceholder": "Descrizione opzionale",
  "qrcode.quantityInvalid": "La quantità deve essere tra 1 e 100",
  "qrcode.generated": "Codici QR generati",
  "qrcode.generatedSuccess": "I codici QR sono stati generati con successo",
  "qrcode.generationFailed":
    "Si è verificato un errore durante la generazione dei codici QR",
  "qrcode.associated": "Codice QR associato",
  "qrcode.associatedSuccess": "Il codice QR è stato associato con successo",
  "qrcode.associationFailed":
    "Si è verificato un errore durante l'associazione del codice QR",
...
const en = {
  ...
  "qrcode.noEmptyCodesDescription":
    "Generate new QR codes to associate with items later",
  "qrcode.prefix": "Prefix",
  "qrcode.prefixHelp":
    "A meaningful prefix helps identify codes (e.g., ITEM-, TOOL-)",
